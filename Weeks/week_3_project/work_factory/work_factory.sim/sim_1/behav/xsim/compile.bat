...
REM
REM Generated by Vivado on Thu Nov 10 22:14:06 +0300 2022
...
echo "xvhdl --incr --relax -prj MyProject_vhdl.prj"
call xvhdl  --incr --relax -prj MyProject_vhdl.prj -log xvhdl.log
